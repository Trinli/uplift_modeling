...
def main():
    ...
    for dataset in DATASETS:
        ...
        # training for larger 'k' might actually be faster as dataset size
        # drops significantly
        k_list = [5, 50, 500]
        for k in k_list:
            # Set model:
            ...
            training_set = data.k_undersampling(k=k)
            ...
            # Predict stage:
            print("Predicting...")
            sampling_rate = 'k {}'.format(k)
            test = {'test_description': 'Direct gradient uplift net with k {}'.format(k),
