...
def run_tests():
    ...
    # to fail.
    import numba
    if numba.__version__ != '0.52.0' and numba.__version__ != '0.53.0':
        ...
        warning_text = "Did not test qini-coefficient. There is a known bug in Numba " +\
        "resulting in erroneous result. Do not use said metric, or comment out the @jit(nopython=True) " +\
        "in the code."
